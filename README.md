...
(･(ง •_•)งﾟ✧ A super easy create canvas poster for Vue!)
# 生成效果
...
### 相关参考
1. [react-canvas-poster](https://github.com/whorcare/react-canvas-poster) 作者：也是俺自己
...
### ISS
[提iss](https://github.com/whorcare/vue-canvas-poster-yufan/issues/new)
